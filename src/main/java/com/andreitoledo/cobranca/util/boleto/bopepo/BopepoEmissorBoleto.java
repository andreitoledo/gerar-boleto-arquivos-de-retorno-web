...
public class BopepoEmissorBoleto implements EmissorBoleto {
	...
	@Override
	public byte[] gerarBoleto(com.andreitoledo.cobranca.model.Cedente cedenteSistema
	...
	@Override
	public File gerarBoletoEmArquivo(String arquivo, com.andreitoledo.cobranca.model.Cedente cedenteSistema, Cobranca cobrancaSistema) {
		Boleto boleto = criarBoleto(cedenteSistema, cobrancaSistema);
	...
	private Boleto criarBoleto(com.andreitoledo.cobranca.model.Cedente cedenteSistema, Cobranca cobrancaSistema) {
	...
	private Titulo criarTitulo(ContaBancaria contaBancaria, Sacado sacado, Cedente cedente
			, com.andreitoledo.cobranca.model.Cobranca cobrancaSistema) {
